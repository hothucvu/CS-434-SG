                ...
                <tbody>
                    ...
                    <?php else: ?>
                        <?php foreach ($fields as $field): 
                            // Tự động map tên cột tránh lỗi key undefined
                            ...
                            if (!empty($img) && file_exists("../assets/uploads/" . $img)) {
                                ...
                                $image_src = "https://images.unsplash.com/photo-1508098682722-e99c43a406b2?q=80&w=200&auto=format&fit=crop"; 
                            }
                        ?>
                        <tr>
                            <td class="fw-bold text-secondary">#<?= $id ?></td>
                            <td>
                                <img src="<?= $image_src ?>" class="rounded shadow-sm" width="90" height="60" style="object-fit: cover;">
                            </td>
